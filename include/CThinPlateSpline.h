...
public:
	...
	**************************************************************************
	...
	the target image.
	***************************************************************************/
	CThinPlateSpline(const std::vector<Point2d>& pS, const std::vector<Point2d>& pD);
	...
	**************************************************************************
	...
	cv::Point-structure
	***************************************************************************/
	Point2d interpolate(const Point2d& p, const TPS_INTERPOLATION tpsInter = BACK_WARP);
	...
	**************************************************************************
	...
	@return                                 void
	***************************************************************************/
	void addCorrespondence(const Point2d& pS, const Point2d& pD);
	...
	**************************************************************************
	...
	@return                                 void
	***************************************************************************/
	void setCorrespondences(const std::vector<Point2d>& pS, const std::vector<Point2d>& pD);
...
private:
	...
	****************************************************************************/
	double fktU(const Point2d& p1, const Point2d& p2);

	void computeSplineCoeffs(std::vector<Point2d>& iP,
		std::vector<Point2d>& iiP, 
		float lambda, 
		const TPS_INTERPOLATION tpsInter = BACK_WARP);

	Point2d interpolate_back_(const Point2d& p);
	Point2d interpolate_forward_(const Point2d& p);


	Mat_<float> cMatrix;
	Mat_<float> mapx;
	Mat_<float> mapy;
	std::vector<Point2d> pSrc;
	std::vector<Point2d> pDst;
};
